...
const universities = graduates.map(function(grads) {
...
const uni = graduates.filter((grads) => {
...
zooAnimals.forEach(function(animal) {
  return animalNames.push('Name: ' + animal.animal_name + ', ' + 'Scientific Name: ' + animal.scientific_name);
});
